...
For JSON-RPC: set the `fusion.jsonrpc.jsonschema.version` annotation-processor option to `2020-12` and the generated
`META-INF/fusion/jsonrpc/openrpc.json` is emitted in Draft 2020-12 instead of the legacy Draft-07 default.
