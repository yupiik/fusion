...
/**
 * {@code {{#unless condition}}} renders the block when the condition is falsy (including {@code false}),
 * the {@code {{else}}} branch otherwise.
 */
public record UnlessVariablePart(ArgEvaluator condition, Part next, Part elsePart, Accessor accessor) implements Part {
    @Override
