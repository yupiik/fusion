---
name: fusion-kubernetes-operator-base
description: Fusion `fusion-kubernetes-operator-base` - Base to build Kubernetes operators with Fusion (watch/reconcile runtime, CRD support). Use when working on or integrating this module, or
