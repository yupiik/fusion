...
generation assertion in `fusion-processor` (see the `fusion-annotation-processing` skill).<!-- generated from fusion-build-internal src/main/resources/agents/skills/fusion-testing/SKILL.md - do not edit -->
