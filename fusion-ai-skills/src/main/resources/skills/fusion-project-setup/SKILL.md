...
run `mvn install -pl fusion-build-internal`.<!-- generated from fusion-build-internal src/main/resources/agents/skills/fusion-project-setup/SKILL.md - do not edit -->
