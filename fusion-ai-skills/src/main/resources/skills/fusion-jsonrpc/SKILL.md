---
name: fusion-jsonrpc
description: Fusion `fusion-jsonrpc` - JSON-RPC 2.0 server on top of the Fusion HTTP server with OpenRPC support. Use when working on or integrating this module, or
