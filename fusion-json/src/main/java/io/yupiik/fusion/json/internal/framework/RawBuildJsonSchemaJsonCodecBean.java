...
public class RawBuildJsonSchemaJsonCodecBean implements FusionBean<RawBuildJsonSchemaJsonCodec> {
    @Override
    public Type type() {
        return RawBuildJsonSchemaJsonCodec.class;
    }
    ...
    @Override
    public RawBuildJsonSchemaJsonCodec create(final RuntimeContainer container, final List<Instance<?>> dependents) {
        return new RawBuildJsonSchemaJsonCodec();
    }

    @Override
    public void destroy(final RuntimeContainer container, final RawBuildJsonSchemaJsonCodec instance) {
        // no-op, stateless
    }
}